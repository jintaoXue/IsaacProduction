...
from omniisaacgymenvs.algo.rainbowmini.model_epsilon import NoduelTrans
...
class NoduelAgent():
    def __init__(self, base_name, params):
        ...
        self.online_net = NoduelTrans(config, self.actions_num).to(device=self._device)
        ...
        self.target_net = NoduelTrans(config, self.actions_num).to(device=self._device)
