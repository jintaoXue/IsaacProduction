...
####TODO state shape
Transition_dtype = np.dtype([('timestep', np.int32), ('state', np.uint8, (20)), ('action', np.int32, (12)), ('reward', np.float32), ('nonterminal', np.bool_)])
blank_trans = (0, np.zeros((20), dtype=np.uint8), np.zeros((12), dtype=np.int32), 0.0, False)
