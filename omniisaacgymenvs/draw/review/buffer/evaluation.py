...
if __name__ == '__main__':
    ...
    algo_dict = {
                 "D3QN":"noe_FactoryTaskAllocationMiC_2024-12-09_21-42-46", 
                 "NoModify":"no_extra_reward_rainbowmini_2025-05-31_12-10-08",
                 "EBQ-G":"epsilon_FactoryTaskAllocationMiC_2024-12-08_17-36-58", 
                 
                 }
    color_dict = {'D3QN': 'darkcyan', 'NoModify': 'gold', 'EBQ-G': 'palevioletred'}
    ...
    draw_metric_from_csv_res(data_list, algo_dict, titles, x_lables, color_dict, log_x, y_tick_f, y_tick, smooth_alphas, 'buffer_metric')
