...
if __name__ == '__main__':
    ...
    #from o1 to o10
    for i in range(1, 11):
        _len = os.path.dirname(__file__) + "/{}_len.csv".format(i)
        _succ = os.path.dirname(__file__) + "/{}_success.csv".format(i)
    ...
    algo_dict = {"D3QN":"test_rainbownoe_ep_8000.pth_2024-12-09_21-42-46", 
                 ...
                 "No_modify":"test_no_extra_reward_rainbowmini_ep_22700.pth_2025-05-31_12-10-08",
                 "EPPO":"test_ppo_discrete_ep_1200.pth_2025-05-21_16-02-29",
                 }
