...
def draw(ax, data_list, title):
    ...
    ax.set_title(title,pad=10,fontsize=16,fontweight="bold")
...
if __name__ == '__main__':
    ...
    draw(ax1, n_date, 'EQX-N')
    draw(ax2, noe_date, 'D3QN')

    plt.tight_layout()
    plt.show()
    path = os.path.dirname(__file__)
    fig.savefig('{}.pdf'.format(path + '/' + 'gant'), bbox_inches='tight')
